...
class Server{
    ...
    middlewares(){
        ...
        this.app.use((request, response, next) => {
            const allowedOrigins = ['https://dev.re-krea.mx', 'https://www.dev.re-krea.mx', 'https://www.dev.distritocasa.com', 'https://dev.distritocasa.com','https://distritocasa.com','https://www.distritocasa.com', 'https://www.dev.distritopyme.com', 'https://dev.distritopyme.com', 'https://impmx.com', 'https://dev.impmx.com', 'https://api-v2.finerio.mx'];
